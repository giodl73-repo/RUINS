...
| `ruins-capability:ancient-genomics-reconstruction-custody` | Ancient genomics reconstruction custody | Active | Cheddar Man paper creates a sample, contamination, coverage, reference-panel, ancestry-model, phenotype, face-reconstruction, identity, and public-race-memory gate; see `docs/capability-promotions/ancient-genomics-reconstruction-custody.md`. | Cheddar Man |
