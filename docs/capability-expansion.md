...
| `ruins-capability:acoustic-space-reconstruction-custody` | Acoustic space reconstruction custody | Active | Stonehenge acoustic scale-model gate and refusal register; see `docs/capability-promotions/acoustic-space-reconstruction-custody.md`. | Stonehenge |
