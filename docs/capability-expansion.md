...
| `ruins-capability:isotopic-mobility-reconstruction-custody` | Isotopic mobility reconstruction custody | Active | Egtved Girl paper creates a sample, tissue-window, baseline, contamination, mobility, identity, and public-origin gate; see `docs/capability-promotions/isotopic-mobility-reconstruction-custody.md`. | Egtved Girl |
