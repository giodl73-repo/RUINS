...
| `ruins-capability:catastrophic-snapshot-preservation-custody` | Catastrophic snapshot preservation custody | Active | Akrotiri ash-burial gate and publication-ready scorecard; see `docs/capability-promotions/catastrophic-snapshot-preservation-custody.md`. | Akrotiri |
