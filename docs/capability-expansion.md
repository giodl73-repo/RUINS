...
| `ruins-capability:gustatory-reconstruction-custody` | Gustatory reconstruction custody | Active | Midas beverage residue gate and refusal register; see `docs/capability-promotions/gustatory-reconstruction-custody.md`. | Midas beverage |
