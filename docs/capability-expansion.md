...
| `ruins-capability:light-mediated-reconstruction-custody` | Light-mediated reconstruction custody | Active | Paleolithic cave-lighting paper creates a fuel, flame, smoke, movement, visibility, experiment, and meaning gate; see `docs/capability-promotions/light-mediated-reconstruction-custody.md`. | Paleolithic cave lighting |
