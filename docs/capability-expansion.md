...
| `ruins-capability:astronomical-alignment-reconstruction-custody` | Astronomical alignment reconstruction custody | Active | Newgrange solstice paper creates an alignment, restoration, observation-window, simulation, calendrical-function, and memory gate; see `docs/capability-promotions/astronomical-alignment-reconstruction-custody.md`. | Newgrange |
