...
| `ruins-capability:notated-performance-reconstruction-custody` | Notated performance reconstruction custody | Active | Hurrian Hymn H6 performance gate and refusal register; see `docs/capability-promotions/notated-performance-reconstruction-custody.md`. | Hurrian Hymn H6 |
