...
| `ruins-capability:olfactory-reconstruction-custody` | Olfactory reconstruction custody | Active | Mendesian perfume reconstruction gate and refusal register; see `docs/capability-promotions/olfactory-reconstruction-custody.md`. | Mendesian perfume |
