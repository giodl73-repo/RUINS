...
| `ruins-capability:paradata-transparency-custody` | Paradata transparency custody | Active | Seville/London virtual-archaeology paper creates a source, metadata, paradata, decision-log, visualization, uncertainty, reuse, and preservation gate; see `docs/capability-promotions/paradata-transparency-custody.md`. | Seville Principles |
