...
| `ruins-capability:dental-calculus-reconstruction-custody` | Dental calculus reconstruction custody | Active | Neanderthal dental-calculus paper creates a plaque, sampling, taxonomic assignment, contamination, diet, microbiome, pathogen, medicine, behaviour, and public life-story gate; see `docs/capability-promotions/dental-calculus-reconstruction-custody.md`. | Neanderthal dental calculus |
