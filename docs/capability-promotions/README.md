...
Status: active promotion record index

This directory stores concrete ASHLAR promotion records for RUINS capabilities.
Use these records when a capability moves from candidate to active or from
active to core.
...
| Dispersed object provenance custody | Active -> Core | [`dispersed-object-provenance-custody.md`](dispersed-object-provenance-custody.md) |
| Cast void identity custody | Active -> Core | [`cast-void-identity-custody.md`](cast-void-identity-custody.md) |
...
| Ancient pathogen genome custody | Candidate -> Active -> Core | [`ancient-pathogen-genome-custody.md`](ancient-pathogen-genome-custody.md) |
| Rock-surface exposure dating custody | Candidate -> Active -> Core | [`rock-surface-exposure-dating-custody.md`](rock-surface-exposure-dating-custody.md) |
...
| Shipwreck context loss | Candidate -> Core | [`shipwreck-context-loss.md`](shipwreck-context-loss.md) |
