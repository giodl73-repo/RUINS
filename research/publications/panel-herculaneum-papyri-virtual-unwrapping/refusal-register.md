# Refusal Register: Herculaneum Papyri Virtual Unwrapping
...
|---|---|
| The Herculaneum library has been recovered. | Only parts of some scrolls are under current public recovery; library-level recovery is an overclaim. |
...
| Public excitement proves original contents. | Cultural memory is afterlife evidence. |
