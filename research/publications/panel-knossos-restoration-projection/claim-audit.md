...
| UNESCO inscription proves every restoration choice was correct. | Refuse | Heritage recognition is modern custody/significance, not room-level validation. |
| Minos/labyrinth mythology explains the archaeology. | Refuse | Myth is cultural memory unless separately source-locked as later reception. |

## Phrases To Challenge

| Phrase | Replacement |
|---|---|
| "the Palace of Minos as the Minoans saw it" | "Evans-era restoration layered onto Bronze Age remains" |
| "fake Knossos" | "ancient site with extensive modern restoration" |
| "reconstructed fresco" | "fragment-based restoration or modern completion, source-specific" |
| "UNESCO proves the restoration" | "UNESCO recognizes the serial heritage property" |
| "labyrinth of King Minos" | "mythic afterlife associated with Knossos" |
