...
corpus history. It also blocks one vivid destruction episode from becoming a
...
| Treating authenticity debate as irrelevant for the Mexico codex | Refuse; name authentication source layer. |
...
5. Separate statement for corpus absence, destruction reports, and surviving
   witness set.
