# Source Lock: Maya Codices Destroyed Corpus
...
|---|---|---|---|---|
| S1 | Library of Congress / WDL, "The Dresden Codex" | institutional digital object record | Lines 329-331 identify the Dresden Codex, say only four Mayan manuscripts still exist worldwide, describe Dresden custody, 39 leaves, screenfold format, and contents. | Dresden object and four-witness frame only. |
| S2 | SLUB Dresden, "The Maya Codex in the SLUB Dresden" | holding institution page | Lines 466-473 describe Dresden quality/content, late post-classical origin, sheets, content, decipherment importance, 1739 acquisition, 19th-century recognition, and colonial-context provenance work. | Dresden custody and institutional framing, not whole corpus proof. |
| S3 | SLUB Dresden, "Other Maya codices" | holding institution overview | Lines 466-482 identify three other original Maya manuscripts, 1562 destruction context, Madrid custody/history, Paris fragility, and Mexico codex authentication/custody. | Overview custody; exact destruction quotation still needs direct edition. |
| S4 | INAH / Museo Nacional de Antropologia, "El Codice Maya de Mexico" | holding institution/exhibition page | Lines 123-125 state 2017 authentication work, radiocarbon range 1021-1154, 2018 naming/custody mandates, and BNAH custody. | Mexico codex authenticity and custody, not complete interpretive reading. |
| S5 | Getty Museum, "Codice Maya de Mexico" | museum exhibition page | Lines 13-17 frame the Mexico codex as the oldest book of the Americas and one of four surviving pre-European Maya manuscripts. | Public/scholarly afterlife; do not use alone for authentication proof. |
...
4. Do not treat the Mexico codex authenticity debate as a casual sidebar; name
   the source layer.
5. Do not publish glyph readings or translations without specialist custody.

## References

- Library of Congress / WDL, "The Dresden Codex":
  https://www.loc.gov/resource/gdcwdl.wdl_11621/?st=gallery
- SLUB Dresden, "The Maya Codex in the SLUB Dresden":
  https://www.slub-dresden.de/en/explore/manuscripts/the-dresden-maya-codex
- SLUB Dresden, "Other Maya codices":
  https://www.slub-dresden.de/en/explore/manuscripts/the-dresden-maya-codex/other-maya-codices
- INAH / Museo Nacional de Antropologia, "El Codice Maya de Mexico":
  https://mna.inah.gob.mx/exposiciones_temporales_detalle.php?pl=El_Codice_Maya_de_Mexico
- Getty Museum, "Codice Maya de Mexico":
  https://www.getty.edu/art/exhibitions/maya_codex/
- Coe, Houston, Miller, Taube, "The Fourth Maya Codex":
  https://www.mesoweb.com/articles/Coe_etal/Fourth_Codex.pdf
- Brown University, "13th century Maya codex, long shrouded in controversy, proves genuine":
