# Replica Status Register: Palmyra Replica Reconstruction

**Owner:** ERRATA / PALIMPSEST
**Status:** first replica-status register

| Surface | Status | Allowed claim | Refused upgrade |
|---|---|---|---|
| Original Palmyra site | Damaged World Heritage property | Site attributes and governance can be named through UNESCO. | "Recovered" without field and governance custody. |
...
A replica can carry documentation and memory. It cannot carry original-fabric,
site-recovery, or authorized-restoration status unless those custody layers are
separately locked.
