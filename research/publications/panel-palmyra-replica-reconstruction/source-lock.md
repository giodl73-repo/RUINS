# Source Lock: Palmyra Replica Reconstruction
...
|---|---|---|---|---|
| S1 | UNESCO World Heritage Centre, "Site of Palmyra" | World Heritage property record | Lines 405-420 define OUV attributes, authenticity concerns, and need for conservation/restoration planning; lines 635-654 identify 1980 inscription and Danger-list status from 2013-present. | Site value and governance custody, not feature-level engineering. |
| S2 | UNESCO, Arch of Triumph destruction news, 5 Oct 2015 | UNESCO news | Lines 260-274 identify date, destruction of the Arch of Triumph, World Heritage status, and the arch's symbolic/urban relation to the colonnade and Temple of Bel. | Destruction/public-memory custody; not damage survey. |
...
| S6 | IDA media page | project/media source | Lines 553-555 describe a 13-tonne replica made with photogrammetry-based 3D modelling and 3D machining in stone, installed in Trafalgar Square and later New York, Dubai, and Florence. | Public/project custody; exact dimensions/materials need direct project audit. |
...
1. Always identify whether a claim concerns original site fabric, documented
...
- UNESCO, "Director-General condemns the destruction of the Arch of Triumph":
  https://whc.unesco.org/en/news/1351
- UNESCO, "Recommendations of the Technical Meeting on the Recovery of the World Heritage Site of Palmyra":
  https://whc.unesco.org/en/news/2133
- UNESCO World Heritage Committee, Decision 46 COM 7A.32:
  https://whc.unesco.org/en/decisions/8501/
- Institute for Digital Archaeology, "The Triumphal Arch":
  https://digitalarchaeology.org.uk/the-triumphal-arch
- Institute for Digital Archaeology, "Triumphal Arch in the News":
  https://digitalarchaeology.org.uk/media
- University of Oxford Physics, "Preserving Palmyra":
  https://www.physics.ox.ac.uk/research/our-research-action/impact-stories/preserving-palmyra
