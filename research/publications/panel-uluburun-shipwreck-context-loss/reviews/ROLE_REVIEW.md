...
|---|---|---|
| Fragment Custodian | The package has a first source map, source lock, and context-loss gate, but detailed cargo, hull, and object claims still need direct publication/page custody. | P2 |
...
- Add page-anchor audit for INA and NEH public claims.
...
- Decide whether `ruins-capability:shipwreck-context-loss` can move from
  candidate to active after page anchors and a second role review.
...
public-summary level and open P2 findings remain.
