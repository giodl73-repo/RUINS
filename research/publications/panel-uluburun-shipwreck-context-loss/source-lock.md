...
draft. It permits high-level source-scoped claims from official/public project
...
|---|---|---|---|
| Project identity | Uluburun is a Late Bronze Age shipwreck excavation associated with INA near Kas, Turkey. | S1 / S2 | Source-specific public project claim |
...
1. Use "Uluburun" as a source-scoped shipwreck case, not as a complete Bronze
   Age trade model.
2. Treat cargo classes as public summary categories unless direct publication
   or catalogue custody is added.
3. Do not publish route, destination, ownership, crew, or exchange-purpose
   closure.
4. Treat museum display as modern custody and cultural memory.
5. Do not provide site-location, diving, recovery, or collecting guidance.
