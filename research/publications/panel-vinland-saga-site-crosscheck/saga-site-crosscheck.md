...
| Claim surface | Current permission |
|---|---|
| L'Anse aux Meadows as confirmed Norse site | Allowed. |
| AD 1021 Norse activity at the site | Allowed, source-scoped to Nature. |
| Site corresponds with Vinland saga traditions | Allowed, source-scoped to UNESCO/Nature. |
| L'Anse aux Meadows equals Vinland | Refuse unless source-specific and qualified. |
| Exact saga quotation or translation | Refuse until direct edition/translation custody is added. |
